...
class LiveCandleBuilder:
    """Builds rolling OHLCV candle lists from WebSocket ticks (thread-safe)."""
    ...
    def has_enough(self, instrument_key: str, timeframe_minutes: int, min_count: int) -> bool:
